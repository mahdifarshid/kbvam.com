...
@section('content')
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        @include('layouts.admin.current_path',['path'=>'لیست بررسی شده ها'])
...
{{--                            <th scope="col">ویرایش</th>--}}
                        ...
                        @foreach($payments as $payment)
                            <tr>
                                ...
                                <td><a style="color: red" href="{{url('paneladmin/set-notpay/'.$payment->id)}}">تنظیم به عنوان بررسی نشده</a>
                                </td>
                    ...
                    <a class="btn btn-danger" href="{{url('/paneladmin/pay/excel/not-payed')}}">دانلود اکسل از بررسی نشده ها</a>
